...
impl Widget for &mut BrowserView {
    fn render(self, area: Rect, buf: &mut Buffer) {
        ...
        let title_color = match self.browser.state() {
            BrowserState::Loaded => Color::Cyan,
            BrowserState::Connecting | BrowserState::Retrieving => Color::Yellow,
            BrowserState::Failed => Color::Red,
            BrowserState::Empty => Color::DarkGray,
        };
